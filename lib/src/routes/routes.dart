...
class AppRouter extends $AppRouter {
  ...
  final List<AutoRoute> routes = [
    ...
    AutoRoute(
      ...
      children: [
        RedirectRoute(path: '', redirectTo: 'dashoard'),
        AutoRoute(path: 'fees', page: FeesView.page),
        AutoRoute(path: 'hostel', page: HostelScreen.page),
        AutoRoute(path: 'transport', page: TransportScreen.page),
        AutoRoute(path: 'leave', page: LeaveScreen.page),
        AutoRoute(path: 'attendance', page: AttendanceView.page),
        AutoRoute(path: 'notice-board', page: NoticeBoardView.page),
        AutoRoute(path: 'task-board', page: TaskBoard.page),
        AutoRoute(path: 'settings', page: Settings.page),
        AutoRoute(path: 'dashoard', page: UniversityDashboard.page),
        AutoRoute(path: 'professor', page: UniversityProfessor.page),
        AutoRoute(path: 'library', page: UniversityLibrary.page),
        AutoRoute(path: 'courses', page: UniversityCourse.page),
        AutoRoute(path: 'staff', page: UniversityStaff.page),
        AutoRoute(path: 'student', page: StudentView.page),
        AutoRoute(path: 'department', page: DepartmentView.page),
        AutoRoute(path: 'holidays', page: HolidayCalender.page),
        AutoRoute(path: 'department', page: DepartmentView.page),
      ],
    ),
  ];
