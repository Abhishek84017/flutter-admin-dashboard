...
class _MenuBarState extends State<FMenuBar> {
  ...
  Map<String, String> mainData = {
    ...
    Strings.university: IconlyBroken.university,
  };
  ...
  List<List<String>> eCommerceExpandList1 = [
    [
      Strings.landingPage,
      Strings.products,
      Strings.cart,
  ...
  /// appbar
  PreferredSizeWidget _appBar(TabsRouter tabsRouter) => AppBar(toolbarHeight: 70,
        elevation: 0.0,
      ...
      itemBuilder: (context, index) {
        if (items.keys.elementAt(index) == Strings.eCommerce) {
          return _menuList1(
            ...
            isExpanded: true,
            children: !isComponent ? eCommerceExpandList : eCommerceExpandList1,
            isopen: isopen,
                  ...
                  Expanded(
                    child: ListTile(
                      ...
                      onTap: () {
                        ...
                        if (items.keys.elementAt(index) == Strings.university) {
                          context.router.push(const University());
                        }
          ...
          if (isExpanded) {
            return isopen
                ? FxExpansionTile(
                    ...
                    children: [_subMenuList(children[0], tabsRouter)],
                  )
                : ListTile(
                    title: isopen
                        ? Text(
